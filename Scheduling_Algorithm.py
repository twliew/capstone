...
# ── FIX 2: Tie-based tiebreaker weight ──────────────────────────────────────
# Adding 1 to score prevents division-by-zero if any score value is 0.
scores = {i: get_score(i) for i in volunteers}
max_score = max(scores.values()) or 1  # avoid division by zero
tie_weights = {
...
P5 = 0.1   # tiebreaker: prefer higher-scoring volunteers when all else is equal
